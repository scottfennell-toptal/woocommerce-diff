 ...
 */
//if ($partial_refund) {
//    $email_heading = __('Your order has been partially refunded', 'woocommerce');
//} else {
//    $email_heading = __('Your order has been refunded', 'woocommerce');
//}
 ...
 * @since 2.5.0
 */
do_action('woocommerce_email_order_details', $order, 1, $plain_text, $email);

/**
 * @hooked WC_Emails::order_meta() Shows order meta data.
 */
do_action('woocommerce_email_order_meta', $order, 1, $plain_text, $email);
